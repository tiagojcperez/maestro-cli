"""Run a full cosmic-ray mutation cycle for loader.py.
...
Side effects:
    - loader-mutations.sqlite        (cosmic-ray session — gitignored)
    - loader-mutation-survivors.txt  (surviving mutant details for the next watch iteration)
"""
...
_CONFIG = "mutations/cosmic-ray-loader.toml"
_SESSION = "mutations/loader-mutations.sqlite"
_SURVIVORS_FILE = "mutations/loader-mutation-survivors.txt"
