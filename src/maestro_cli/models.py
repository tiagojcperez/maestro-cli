...
ContextMode = Literal["raw", "summarized", "map_reduce", "recursive", "layered", "selective", "structural", "council", "knowledge_graph", "codebase_map"]
...
CONTEXT_MODES: set[str] = {"raw", "summarized", "map_reduce", "recursive", "layered", "selective", "structural", "council", "knowledge_graph", "codebase_map"}
MAX_RETRIES_LIMIT = 3
